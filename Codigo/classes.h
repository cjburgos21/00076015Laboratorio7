...
enum parameters {TAO_CONSTANTE,KAPPA_CONSTANTE,LAMBDA_CONSTANTE,PSIX_CONSTANTE,PSIY_CONSTANTE,DELTA_CONSTANTE,ETA_CONSTANTE};
...
class mesh{
    ...
    public:
        void setParameters(float tao,float kappa, float lambda, float psix, float psiy, float delta, float eta){
            parameters[TAO_CONSTANTE]=tao;
            parameters[KAPPA_CONSTANTE]=kappa;
            parameters[LAMBDA_CONSTANTE]=lambda;
            parameters[PSIX_CONSTANTE]=psix;
            parameters[PSIY_CONSTANTE]=psiy;
            parameters[DELTA_CONSTANTE]=delta;
            parameters[ETA_CONSTANTE]=eta;
        }
